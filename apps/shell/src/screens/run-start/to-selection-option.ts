 ...
 *  más de 5 opciones) — el catálogo de juguete no tiene arte propio todavía, así que el acento de
 *  color es el único diferenciador visual entre tarjetas hasta que exista arte real. */

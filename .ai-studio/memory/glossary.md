...
- **Pool de Núcleos:** conjunto compartido de fichas de Núcleo disponible para ambos lados del combate; se relanza por completo al vaciarse. Tamaño fijado en 8 fichas. Cada ficha elige color (entre los 5) y valor (1-4) de forma independiente y puramente al azar — no hay garantía de que los 5 colores estén representados en un relanzado dado; esto es intencional (ver Habilidad Neutra) y no un defecto a corregir.